...
namespace WFA_Etut
{
    public partial class Form1 : Form
    {
        ...
        private void brnTextDegistir_Click(object sender, EventArgs e)
        {
            //lblInput.Text = "Saat 20:15 bugün günlerden" + DateTime.Now.DayOfWeek;
            lblInput.Text = 14 +" birincisayi";
        }
    }
}
